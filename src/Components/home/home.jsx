      ...
      <div className="gradientBackground " style={{height:"600px"}}>
        <Carousel className="carousalStyle">
          <Carousel.Item interval={1000}>
            <img id="carousalImg" className="d-block w-50 mt-5 my-5 mx-auto " src={Banner} alt="" />
            <Carousel.Caption>
          ...
          <Carousel.Item interval={1500}>
            <img id="carousalImg" className="d-block w-50 mt-5 my-5 mx-auto" src={Banner4} alt="" />
            <Carousel.Caption>
              <h3>Happy Wedding</h3>
          ...
          <Carousel.Item>
            <img id="carousalImg" className="d-block w-50 mt-5 my-5 mx-auto" src={Banner2} alt="" />
          ...
          <Carousel.Item interval={2500}>
            <img id="carousalImg" className="d-block w-50 mt-5 my-5 mx-auto" src={Banner3} alt="" />
            <Carousel.Caption>
              {/* <h3>Third slide label</h3> */}
              <p>
                {/* Praesent commodo cursus magna, vel scelerisque nisl consectetur. */}
          ...
          <Carousel.Item interval={3000}>
            <img id="carousalImg" className="d-block w-50 mt-5 my-5 mx-auto" src={Banner1} alt="" />
            <Carousel.Caption>
              {/* <h3>Third slide label</h3> */}
              <p>
                {/* Praesent commodo cursus magna, vel scelerisque nisl consectetur. */}
